...
from pulpwise import __version__
from pulpwise.tui.views import VIEWS, SyncView, View


class PulpwiseApp(App[None]):
    TITLE = f"pulpwise {__version__}"
    SUB_TITLE = "content pipeline for Readwise Reader"
